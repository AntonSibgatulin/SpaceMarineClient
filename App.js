...
if(err){
  return;
    ...
    fetch(host+"/spacemarines/create", {
      method: 'POST', // Default is 'get'
      body: xml,
      mode: 'cors',
      headers: new Headers({
...
for(var i = 0 ;i<elemento.querySelectorAll("SpaceMarine").length;i++){
  ...
  function buttonCreate(){
    ...
    searchPanel.current.style="display:none";

    lessThenCurret.current.style="display:none";
    minimums.current.style="display:none";
  ...
  function lessThenCurretFunS(){

    var value = lessThenCurret.current.querySelector("select[name='weaponType']").value;
    console.log(value)
    fetch(host+"/spacemarines/weapon-types/less-then-current?weapon="+value, {
      method: 'GET', // Default is 'get'
      mode: 'cors',
      headers: new Headers({
        'Content-Type': 'application/xml'
  ...
  function minimumsFunS(){

    var value = minimums.current.querySelector("select[name='weaponType']").value;
    console.log(value)
    fetch(host+"/spacemarines/weapon-types/minimum/"+value, {
      method: 'GET', // Default is 'get'
      mode: 'cors',
      headers: new Headers({
        'Content-Type': 'application/xml'
  ...
  function marinesFunS(){
    ...
    var value = marines.current.querySelector("input[name='name']").value;
    console.log(value)
    fetch(host+"/spacemarines/chapters/marines?marines="+value, {
      method: 'GET', // Default is 'get'
      mode: 'cors',
      headers: new Headers({
        'Content-Type': 'application/xml'
  ...
  return (
    ...
    <div class="main-panel">
      ...
      <a onClick={buttonUpdate}>Update</a>
      <a onClick={buttonGet}>Get</a>
      <a onClick={buttonDelete}>Delete</a>
      <a onClick={searchButton}>Search</a>
      <a onClick={lessThenCurretFun}>Less-then-curret</a>
      <a onClick={minimumsFun}>Minimum</a>
      <a onClick={marinesFun}>Marines</a>
      <a href="https://se.ifmo.ru/~s282365/soa22/">Marines</a>
      
    </div>
    <div id="container">
      <div class="create" ref={create} id="create" style={{display:"none"}}>
        <div class="flex-center">
          <input type="text" placeholder="Name" name="name" />
        </div>
        <div class="block">
          <div class="flex-center margin-left"> Coordinates </div>
          <div class="flex-left">
      ...
      <div class="flex-center">
            <a class="button" onClick={getSpaceMarine}>Get</a>
          </div>
      </div>
      ...
      <div class="create" ref={searchPanel} id="searchPanel">
      <div class="block">
      <div class="flex-center">
          <select name="type_of_search" onChange={onChangeSelectSearch}>
            <option value="0" selected>Name</option>
            <option value="1">Health</option>
            <option value="2">Creation Date</option>
            <option value="3">Category</option>
            <option value="4">Weapon Type</option>
        ...
        <div name="FindByName" class="block margintop">
        <div class="flex-center">
          <input type="text" placeholder="Name" name="name" />
        </div>
      </div>
      ...
      <div name="FindByHealth" class="block margintop" style={{display:"none"}}>
      <div class="flex-center">
        <input type="range" id="min" name="health"
         min="1" max="1000" step={1}/>
          <label for="min">Min</label>
        </div>

        <div class="flex-center">
        <input type="range" id="max" name="maxhealth"
         min="1" max="1000" step={1}/>
      ...
      <div name="FindByData" class="block margintop" style={{display:"none"}}>
      <div class="flex-center">
      ...
      <div name="FindByCategory" class="block margintop" style={{display:"none"}}>
      <div class="flex-center">
          <select name="category">
            <option value="DREADNOUGHT" selected>DREADNOUGHT</option>
            <option value="AGGRESSOR">AGGRESSOR</option>
      ...
      <div name="FindByWeaponType" class="block margintop" style={{display:"none"}}>
      <div class="flex-center">
          <select name="weaponType">
            <option value="BOLTGUN" selected>BOLTGUN</option>
            <option value="MELTAGUN">MELTAGUN</option>
      ...
      <div name="FindByMeleeWeapon" class="block margintop" style={{display:"none"}}>
      <div class="flex-center">
          <select name="meleeWeapon">
            <option value="CHAIN_AXE" selected>CHAIN_AXE</option>
            <option value="MANREAPER">MANREAPER</option>
      ...
      <div name="SortByBy" class="block margintop" >
        <div class="flex-left">
          SortBy
        </div>
      <div class="flex-center">
          <select name="sortBy">
            ...
            <option value="meleeWeapon">meleeWeapon</option>
          </select>
        </div>
      </div>
  ...
  <input type="text" placeholder="Size" name="size" />
      ...
      <div class="flex-center">
            <a class="button" onClick={searchFun}>Search</a>
          </div>
        ...
        <div class="create" ref={lessThenCurret} style={{display:"none"}}>
  <div class="flex-center">
          <select name="weaponType">
            <option value="BOLTGUN" selected>BOLTGUN</option>
            <option value="MELTAGUN">MELTAGUN</option>
      ...
      <div class="flex-center">
        <a class="button" onClick={lessThenCurretFunS}>Search</a>
      </div>
</div>



<div class="create" ref={minimums} style={{display:"none"}}>
<div class="flex-center">
          <select name="weaponType">
          <option value="BOLTGUN" selected>BOLTGUN</option>
            <option value="MELTAGUN">MELTAGUN</option>
      ...
      <div class="flex-center">
        <a class="button" onClick={minimumsFunS}>Search</a>
      </div>
</div>
...
<div class="flex-center">
<input type="number" min={0} placeholder="Count of marines" name="name" />
        
        </div>
      <div class="flex-center">
        <a class="button" onClick={marinesFunS}>Search</a>
      </div>
</div>
...
<div style={{display:"none"}} ref={preview_ship}>
    ...
    <div class="flex-center">
          <div type="number" placeholder="id" name="id"></div>
         
        </div>
        <div class="flex-center">
          <div type="text" placeholder="Name" name="name"></div>
        </div>
        <div class="block">
          <div class="flex-left margin-left"> Coordinates </div>
          <div class="flex-center">
            <div type="number" placeholder="x" name="x"></div>
          </div>
          <div class="flex-center">
            <div type="number" placeholder="y" name="y"></div>
          </div>
        </div>
        <div class="flex-center">
          <div type="number" placeholder="health" name="health" max={1000} min={1}></div>
        </div>
        <div class="flex-center">
          <select name="category">
            <option value="DREADNOUGHT" selected>DREADNOUGHT</option>
        ...
        <div class="flex-center">
          <select name="meleeWeapon">
            ...
            <option value="MANREAPER">MANREAPER</option>
            <option value="LIGHTING_CLAW">LIGHTING_CLAW</option>
            <option value="LIGHTING_CLAW">POWER_FIST</option>
          </select>
        </div>
        <div class="block">
          <div class="flex-center margin-left"> Chapter </div>
          <div class="flex-left">
            <div type="text" placeholder="name" name="cname"></div>
          </div>
          <div class="flex-left">
            <div type="text" placeholder="parentLegion" name="pname"></div>
          </div>
          <div class="flex-left">
            <div type="number" placeholder="marinesCount" name="marinesCount"></div>
          </div>
          <div class="flex-left">
            <div type="text" placeholder="world" name="world"></div>
          </div>
        </div>
